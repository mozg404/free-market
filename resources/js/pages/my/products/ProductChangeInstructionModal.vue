...
const form = useForm({
  instruction: props.product.instruction,
  _method: 'PATCH',
})

const modalRef = ref(null)
const submit = () => form.post(route('my.products.change.instruction.update', props.product.id), {
...
<template>
  <Modal max-width="2xl" ref="modalRef">
    <div class="text-2xl font-semibold mb-8">Редактирование инструкции</div>
