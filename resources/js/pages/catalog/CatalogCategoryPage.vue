...
import CatalogFeaturesFilters from "@/components/modules/catalog/CatalogFeaturesFilters.vue";
        ...
        <template #sidebar_left>
          ...
          <Box title="Фильтры">
            <div class="space-y-8">
              ...
              <CatalogFeaturesFilters v-model="filters.features" :features="features" />
